    ...
    <div className="side-navbar">
      ...
      <div className="nav" id="affNav">
        ...
        <Link href="/affiliate">
          <a
            className={`nav-link ${
              current === "/affiliate" && "active-current"
            }`}
          >
            Dashboard
          </a>
        ...
        <Link href="/affiliate/kyc">
          <a
            className={`nav-link ${
              current === "/affiliate/kyc" && "active-current"
            }`}
          >
            KYC
          </a>
        ...
        <Link href="/affiliate/affiliates">
          <a
            className={`nav-link ${
              current === "/affiliate/affiliates" && "active-current"
            }`}
          >
            Affiliates
          </a>
        ...
        <Link href="/affiliate/leaderboard">
          <a
            className={`nav-link ${
              current === "/affiliate/leaderboard" && "active-current"
            }`}
          >
            Leaderboard
          </a>
        ...
        <Link href="/support">
          <a
            className={`nav-link ${current === "support" && "active-current"}`}
          >
            Support
          </a>
        </Link>
